...
### Ekrānšāviņi
|               Sākums               |               Spēles iestatīšana               |              Spēle               |              Pieskaitīšana              |
|:----------------------------------:|:----------------------------------------------:|:--------------------------------:|:---------------------------------------:|
| ![Sākums](imgs/start.jpg?raw=true) | ![Spēles iestatīšana](imgs/setup.jpg?raw=true) | ![Spēle](imgs/game.jpg?raw=true) | ![Pieskaitīšana](imgs/add.jpg?raw=true) |
